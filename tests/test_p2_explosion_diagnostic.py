...
def test_explosion_diagnostic_records_existing_guard_state():
    ...
    record = explosion_diagnostic(
        ...
        initial_positions=np.array(
            [[0.0, 0.0, 0.0], [1.5, 0.0, 0.0]], dtype=float
        ),
        initial_forces=np.array(
            [[0.2, 0.0, 0.0], [1.5, 0.0, 0.0]], dtype=float
        ),
        species=["Li", "O"],
    ...
    assert record["local_environment"]["initial_force_eV_A"] == 1.5
    ...
    assert record == {
        ...
        "local_environment": {
            "atom_index": 1,
            "atom_species": "O",
            "initial_position_A": [1.5, 0.0, 0.0],
            "explosion_position_A": [2.0, 0.0, 0.0],
            "initial_force_eV_A": 1.5,
            "explosion_force_eV_A": 2.0,
            "force_change_eV_A": 0.5,
            "initial_neighbors": [
